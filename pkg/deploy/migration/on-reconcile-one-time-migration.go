...
func addPartOfCheLabeltoUserDefinedObjects(ctx *chetypes.DeployContext) error {
	...
	// Proxy credentials
	proxyCredentialsSecret := utils.GetValue(ctx.CheCluster.Spec.ServerComponents.CheServer.Proxy.CredentialsSecretName, constants.DefaultProxyCredentialsSecret)
