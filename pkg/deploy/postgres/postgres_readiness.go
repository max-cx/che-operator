...
func getCheckPostgresReadinessScript(deployContext *chetypes.DeployContext) string {
	chePostgresHostName := utils.GetValue(deployContext.CheCluster.Spec.ServerComponents.Database.PostgresHostName, constants.DefaultPostgresHostName)
	chePostgresPort := utils.GetValue(deployContext.CheCluster.Spec.ServerComponents.Database.PostgresPort, constants.DefaultPostgresPort)
